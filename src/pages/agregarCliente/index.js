                ...
                <div className='row-tipo'>
                  <div className="column-1">
                    <div className="div-duo mb-2">
                      <h4 className='fw-bold me-5'>Tipo de plan: </h4>
                      <div className='row-2'>
                        <div className='col col-12 col-lg-3 col-md-3 w-100 pt-1' /* style={{backgroundColor:'green'}} */>
                          <label className='fw-bold w-25' style={{cursor:'pointer'}}>
                            <input type='radio' style={{cursor:'pointer'}} checked={checked1} onChange={()=>(checkedPlan(1),setPlan('Plan 1'))}/>
                            Plan 1
                          </label>
                          <label className='fw-bold w-25' style={{cursor:'pointer'}}>
                            <input type='radio' style={{cursor:'pointer'}} checked={checked2} onChange={()=>(checkedPlan(2),setPlan('Plan 2'))}/>
                            Plan 2
                          </label>
                          <label className='fw-bold w-25' style={{cursor:'pointer'}}>
                    ...
                    <div className="mb-2 pb-1">
                      ...
                      <TextField id="outlined-basic" className=" w-100 " size="small" label='Ej: SOS, Sura, NUevaa EPS' variant='outlined'></TextField>
                    </div>
                    <div className="mb-2 pb-1">
