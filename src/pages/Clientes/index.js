...
export default function Clientes(){
    ...
    const BotonColorCambiante = ({ children }) => {
      ...
      return (
        <button
          className="fw-bold ms-2 mb-3 clases"
          style={buttonStyle}
    ...
    return(
        <>
        {(isLogged && (user.role === 'admin' || user.role==='recepcionista' || user.role==='coach')) && (
          <div>
            ...
            <div className='w-100 d-flex flex-row '>
              ...
              <div className='pt-4 w-100 ps-4 d-flex flex-column' >
                <div className='container-fluid mt-4 mb-3'>
                  <div className='row'>
                    <div className='col col-12 col-lg-6 col-md-12 d-flex pt-4'>
                        {user.role==='coach' && 
                          <div className='div-huella w-100 div-buscar'>
                            <h2 
                              className='fw-bold d-flex justify-content-start text-align-start mt-1 me-3'
                            >Buscar:</h2>
                    ...
                    {user.role !=='coach' &&
                    <div className='col clases col-12 col-lg-6 col-md-12 d-flex justify-content-center text-align-center mt-4 '>
                ...
                {user.role!== 'coach' && 
                <div className='d-flex clases w-100 justify-content-center text-align-center mt-4'>
                  <BotonColorCambiante className='fw-bold' style={{backgroundColor:'black',color:'white'}}>Nuevo Cliente<GoPersonAdd className='ms-1 mt-1 fw-bold'/></BotonColorCambiante>
                </div>
                }
              </div>
            </div>
