          ...
          <div className='w-100 d-flex flex-row '>
            ...
            <div className='pt-4 w-100 ps-4 d-flex flex-column' >
              ...
              <div className='d-flex w-100 justify-content-center text-align-center mt-4'>
                <BotonColorCambiante className='fw-bold clases' style={{backgroundColor:'black',color:'white'}}>Registrar Empleado<IoMdAddCircleOutline   className='ms-1 mt-1 fw-bold'/></BotonColorCambiante>
              </div>
            </div>
          </div>
        </div>
